...
public class ComponentPlaceholderContent {
    ...
    public static void swap(int fromPosition, int toPosition){
        ...
        ComponentPlaceholderContent.PlaceholderItem fromItem = ELEMENTS.get( fromPosition);
        ComponentPlaceholderContent.PlaceholderItem toItem = ELEMENTS.get( toPosition);
